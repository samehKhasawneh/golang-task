...
func CreateAuth(rc *redis.Client, userid uint32, td *TokenDetails) error {
...
func FetchAuth(rc *redis.Client, authD *AccessDetails) (uint32, error) {
...
func DeleteAuth(rc *redis.Client, givenUuid string) (int64, error) {
